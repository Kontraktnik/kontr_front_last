...
@Component({
  selector: 'app-vtsh-update',
  templateUrl: './vtsh-update.component.html',
  styleUrls: ['./vtsh-update.component.scss']
})
export class VtshUpdateComponent implements OnInit {
  ...
  constructor(private service:VtshService ,private toastr:ToastrService,private route: ActivatedRoute,) {
  ...
  saveForm(){
    if(this.fbGroup.valid){
      var model = this.fbGroup.getRawValue() as Vtsh;
